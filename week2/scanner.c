...
Token *readNumber(void)
{
    ...
    int count = 0;
    int checkItIsFloat = 0;
    if (checkFloatWithPeriod)
    {
...
Token *readString(void)
{
    ...
    {
        token->string[count] = (char)39;
        readChar();
        return token;
    }
    else
    {
        error(ERR_INVALIDDOUBLEQUOTE, lineNo, colNo);
    }
}
Token *getToken(void)
{
